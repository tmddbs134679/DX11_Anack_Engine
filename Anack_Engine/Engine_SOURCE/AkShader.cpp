...
namespace Ak
{
	...
	bool Shader::Create(const eShaderStage _stage, const std::wstring& _fileName, const std::string& _funName)
	{
		...
		else if (_stage == eShaderStage::GS)
		{
			GetDevice()->CompileFromfile(
				fullPath
				, _funName
